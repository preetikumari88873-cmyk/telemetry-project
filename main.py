...
with open(BASE_DIR / "data-1.json", "r", encoding="utf-8") as f:
    jsonData1 = json.load(f)
with open(BASE_DIR / "data-2.json", "r", encoding="utf-8") as f:
    jsonData2 = json.load(f)
with open(BASE_DIR / "data-result.json", "r", encoding="utf-8") as f:
